...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep, scale=0.8]
    ...
    \node[annot,below of=S1-1, node distance=1.0cm] (bs1) {25 weights\\5 biases};
    \node[annot,below of=H-1, node distance=1.0cm] (bhl) {25 weights\\5 biases};
    \node[annot,below of=S2-1, node distance=1.0cm] (bs2) {25 weights\\5 biases};
    \node[annot,right of=bs2] {5 weights\\1 bias};
\end{tikzpicture}