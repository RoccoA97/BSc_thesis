...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(feature[:,0], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()
...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(feature[:,1], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()
...
plt.xlabel('$\eta_{1}$')
plt.ylabel('Density')
plt.hist(feature[:,2], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()
...
plt.xlabel('$\eta_{2}$')
plt.ylabel('Density')
plt.hist(feature[:,3], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()
...
plt.ylabel('Density')
plt.hist(feature[:,4], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()
...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(feature[:,5], bins=nbins, histtype='step', linewidth=2, density=True, label='Signal+Background')
plt.legend()

fig.savefig('./Python/Z/sig_plus_bkg.pdf')
plt.clf()
fig.clf()
