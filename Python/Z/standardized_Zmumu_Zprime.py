...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(background[:,0], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,0], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()
...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(background[:,1], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,1], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()
...
plt.xlabel('$\eta_{1}$')
plt.ylabel('Density')
plt.hist(background[:,2], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,2], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()
...
plt.xlabel('$\eta_{2}$')
plt.ylabel('Density')
plt.hist(background[:,3], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,3], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()
...
plt.ylabel('Density')
plt.hist(background[:,4], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,4], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()
...
plt.ylabel('Density')
plt.yscale('log')
plt.hist(background[:,5], bins=1000, histtype='step', linewidth=2, density=True, label='Background')
plt.hist(signal[:,5], bins=100, histtype='step', linewidth=2, density=True, label='Signal')
plt.legend()

fig.subplots_adjust(left = 0.05,right = 0.95,bottom = 0.025,top = 0.975)
fig.savefig('./Python/Z/standardized_Zmumu_Zprime.pdf')
plt.clf()
fig.clf()
