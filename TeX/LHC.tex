...
\begin{minipage}{0.4\textwidth}
	\centering
	\input{Images/LHC/res_cross_section.tex}
\end{minipage}
%
\begin{minipage}{0.4\textwidth}\centering
	\includegraphics[width=1.0\linewidth]{Python/LHC/RES/res1.pdf}
\end{minipage}%Images/LHC/res_cross_section.tex
...
\begin{minipage}{0.4\textwidth}
	\centering
	\input{Images/LHC/res_inv_mass.tex}
\end{minipage}
%
\begin{minipage}{0.4\textwidth}\centering
	\includegraphics[width=1.0\linewidth]{Python/LHC/RES/res2.pdf}
\end{minipage}%Images/LHC/ref_inv_mass.tex
