...
#output path
#OUTPUT_PATH = '/home/ArdinoPierfrancesco/Desktop'
OUTPUT_PATH = 'C:\\Users\\Ardino Pierfrancesco\\Desktop\\TEST_TF'
#toy
toy = '1'
#signal path
#INPUT_PATH_SIG = sys.argv[3] #'/eos/project/d/dshep/BSM_Detection/Zprime_lepFilter_13TeV/'
#INPUT_PATH_SIG = '/home/ArdinoPierfrancesco/Desktop/DATA/Zprime_lepFilter_13TeV/'
INPUT_PATH_SIG = 'C:\\Users\\Ardino Pierfrancesco\\Desktop\\DATA\\Zprime_lepFilter_13TeV\\'

#background path
#INPUT_PATH_BKG = '/home/ArdinoPierfrancesco/Desktop/DATA/Zmumu_lepFilter_13TeV/'
INPUT_PATH_BKG = 'C:\\Users\\Ardino Pierfrancesco\\Desktop\\DATA\\Zmumu_lepFilter_13TeV\\'
...
ID = '\\Z_5D_patience'+str(patience)+'_ref'+str(N_ref)+'_bkg'+str(N_Bkg)+'_sig'+str(N_Sig)+'_epochs'+str(total_epochs)+'_latent'+str(latentsize)+'_wclip'+str(weight_clipping)+'_run'+str(n_run)
...
loss_value, grads = grad(BSMfinder, feature, target)

print("Step: {}, Initial Loss: {}".format(global_step.numpy(),
                                          loss_value.numpy()))
optimizer.apply_gradients(zip(grads, BSMfinder.trainable_variables), global_step)
print("Step: {},         Loss: {}".format(global_step.numpy(),
                                          Loss(BSMfinder(feature), target).numpy()))
